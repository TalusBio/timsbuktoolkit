...
if [ -n "${FULL_RUN}" ]; then
    ...
    SPECLIB_NAME="data_ignore/20231030_LINEARIZED_UP000005640_9606.ndjson.zst"
    ...
    SPECLIB_NAME="data_ignore/vimentin.ndjson.zst"
    ...
    SPECLIB_NAME="data_ignore/asdad.ndjson.zst"
