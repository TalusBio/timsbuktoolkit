...
if [ -n "${FULL_RUN}" ]; then
    ...
    SPECLIB_NAME="data_ignore/20231030_LINEARIZED_UP000005640_9606.mzspeclib.txt.gz"
    ...
    SPECLIB_NAME="data_ignore/vimentin.mzspeclib.txt.gz"
    ...
    SPECLIB_NAME="data_ignore/hela_gt20peps.mzspeclib.txt.gz"
